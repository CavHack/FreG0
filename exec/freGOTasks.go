...
func (task *FreGOTask) ExecSuperstep(params *protos.ExecSuperstepParams) (*protos.ExecSuperstepResult, error) {
	startTime := time.Now()
...
func (task *FreGOTask) loadVertexMessages(superstep int, vrange store.VertexRange) (map[string]interface{}, error) {
...
func (task *FreGOTask) loadHaltedVertices(superstep int, vrange store.VertexRange) (map[string]bool, error) {
...
func (task *FreGOTask) saveEntities(entities *messagesProcessor.ProcessResultEntities) error {
